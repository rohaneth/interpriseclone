...
import svcMini from "@/assets/service-mini-excavator.jpg";
import svcPoclain from "@/assets/service-poclain.jpg";
import svcCompact from "@/assets/service-compact.jpg";
import svcBobcat from "@/assets/service-bobcat.jpg";
...
const services = [
  { title: "Mini Excavator", img: svcMini, blurb: "Reliable mini excavator rental in Pune for tight access sites and quick excavation work." },
  { title: "Mini Poclain", img: svcPoclain, blurb: "Affordable poclain rentals for trenching, earthmoving and rock breaking jobs." },
  { title: "Compact Excavator", img: svcCompact, blurb: "Perfect for residential, commercial and industrial projects of any size." },
  { title: "Mini Bobcat", img: svcBobcat, blurb: "Power, precision and a compact footprint for fast, clean material handling." },
];
...
function Hero() {
  return (
    <section id="home" className="relative overflow-hidden">
      <img src={heroImg} alt="Mini excavator working on a construction site at dusk" width={1920} height={1080} className="absolute inset-0 h-full w-full object-cover" />
    ...
    <section id="why" className="py-20 md:py-28">
      <div className="container-x grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          <img src={svcPoclain} alt="Poclain at work" loading="lazy" width={800} height={600} className="rounded-xl aspect-square object-cover" />
          <img src={svcCompact} alt="Compact excavator" loading="lazy" width={800} height={600} className="rounded-xl aspect-square object-cover mt-10" />
          <img src={svcBobcat} alt="Bobcat mini" loading="lazy" width={800} height={600} className="rounded-xl aspect-square object-cover" />
          <img src={svcMini} alt="Mini excavator" loading="lazy" width={800} height={600} className="rounded-xl aspect-square object-cover mt-10 bg-white" />
        </div>
      </div>
    </section>
  );
  ...
  return (
    <section id="contact" className="py-20 md:py-24 bg-[var(--brand)] text-primary-foreground">
      <div className="container-x grid lg:grid-cols-2 gap-10 items-center">
        ...
        <form onSubmit={(e) => e.preventDefault()} className="bg-white text-foreground rounded-xl p-6 shadow-xl">
          <h3 className="font-display text-2xl text-[var(--ink)]">Request a Quote</h3>
          <div className="mt-4 grid sm:grid-cols-2 gap-3">
            <input required placeholder="Your name" className="px-4 py-3 rounded-md border bg-background outline-none focus:ring-2 ring-[var(--brand)]" />
            <input required type="tel" placeholder="Phone number" className="px-4 py-3 rounded-md border bg-background outline-none focus:ring-2 ring-[var(--brand)]" />
          </div>
          <input placeholder="Project location" className="mt-3 w-full px-4 py-3 rounded-md border bg-background outline-none focus:ring-2 ring-[var(--brand)]" />
          <select className="mt-3 w-full px-4 py-3 rounded-md border bg-background outline-none focus:ring-2 ring-[var(--brand)]">
            <option>Mini Excavator</option><option>Mini Poclain</option><option>Compact Excavator</option><option>Mini Bobcat</option>
          </select>
          <textarea rows={3} placeholder="Tell us about your work" className="mt-3 w-full px-4 py-3 rounded-md border bg-background outline-none focus:ring-2 ring-[var(--brand)]" />
          <button className="mt-4 w-full rounded-md bg-[var(--brand)] text-primary-foreground py-3 font-semibold hover:brightness-110 transition">Send Enquiry</button>
        </form>
      </div>
    </section>
  );
